...
import contactImg from "../assets/img/port2.png";
import 'animate.css';
...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let response = await fetch("https://formsubmit.co/juanmrucci@gmail.com", {
      method: "POST",
      body: formData
    });
    setButtonText("Send");
              ...
              {({ isVisible }) =>
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="tel" value={formDetails.phone} placeholder="No. de Telefono" onChange={(e) => onFormUpdate('phone', e.target.value)}/>
                    </Col>
